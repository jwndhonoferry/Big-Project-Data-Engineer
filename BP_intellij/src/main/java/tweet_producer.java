...
public class tweet_producer {
    private static void run(String consumerKey, String consumerSecret,
        ...
        try (Producer<Long, String> producer = getProducer()) {
            while (true) {
                ...
                ProducerRecord<Long, String> message = new ProducerRecord<>(conf.TOPIC, queue.take());
    ...
    public static void main(String[] args) {
        ...
        tweet_producer.run(consumer_key, consumer_secret, access_token, access_token_secret, words_search_key);
